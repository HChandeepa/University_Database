...
create procedure AddNewStudent1(
...
insert into PhoneNo(StudentID,PhoneNo)
...
END;
 ...
 as
 select StudentID,PostDate as Payement_Date,Amount,PaymentType
 from Payment;
